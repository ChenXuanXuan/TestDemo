...
public class ViewPageFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    public ViewPageFragmentAdapter(FragmentManager fm,
        ...
        mPagerStrip.setOnPagerChange(new PagerSlidingTabStrip.OnPagerChangeLis() {
            @Override
            public void onChanged(final int page) {
       /*         for (int i = 0; i < getCount(); i++) {
                    if (i != page)
                        textlist.get(i).setTextSize(16);
                    else {
                        textlist.get(page).setTextSize(20);
                    }
                }*/
            /*    lastpage = page;
                ...
                MainActivity.handler.postDelayed(runnable, 500);*/
            }
    ...
    public void addTab(String title, String tag, Class<?> clss) {
        ViewPageInfo viewPageInfo = new ViewPageInfo(title, tag, clss);
        addFragment(viewPageInfo);
    }
