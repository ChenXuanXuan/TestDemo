...
public class ImageHelper {
    ...
    * */
    public static Bitmap handleImageEffect(Bitmap bm ,float hue ,float saturation ,float lum){
        ...
        Bitmap bmp = Bitmap.createBitmap(bm.getWidth(),bm.getHeight(), Bitmap.Config.ARGB_8888);//新建bitmap
        Canvas canvas = new Canvas(bmp);//创建画布
        Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);//创建画笔，并抗锯齿

        //ColorMatrix 颜色矩阵类   该类可以调整图像属性
        ...
        //创建imageMatrix 柔和前面三个ColorMatrix
